...
import { GraduationCap, School, Award, Calendar, FileText, ArrowLeft, Plus, Star, AlertTriangle, CheckCircle, X } from 'lucide-react';
...
const AddEducation = () => {
  ...
  const validateForm = () => {
    ...
    if (!school.trim()) {
      newErrors.school = 'School or Bootcamp is required';
    }
    
    if (!degree.trim()) {
      newErrors.degree = 'Degree or Certificate is required';
    }
    ...
    if (!current && !to) {
      newErrors.to = 'To date is required (or check Current School)';
    }
    ...
    <>
      ...
      <div style={containerStyle}>
          ...
          <div style={formCardStyle} className="form-card">
            <form onSubmit={onSubmit}>
              ...
              <div style={formGroupStyle}>
                ...
                <input
                  type="text"
                  placeholder="Enter school or bootcamp name"
                  name="school"
                  value={school}
                  onChange={onChange}
                  required
                  style={errors.school ? inputErrorStyle : inputStyle}
                  className={errors.school ? "form-input-error" : "form-input"}
                />
                {errors.school && (
              ...
              <div style={formGroupStyle}>
                ...
                <input
                  ...
                  className={errors.degree ? "form-input-error" : "form-input"}
                />
                {errors.degree && (
                  <div style={alertStyle}>
                    <AlertTriangle size={16} />
              ...
              <div style={formGroupStyle}>
                ...
                <input
                  ...
                  onChange={onChange}
                  required
                  style={errors.fieldofstudy ? inputErrorStyle : inputStyle}
                  className={errors.fieldofstudy ? "form-input-error" : "form-input"}
                />
                {errors.fieldofstudy && (
                  <div style={alertStyle}>
                    <AlertTriangle size={16} />
              ...
              <div style={formGroupStyle}>
                ...
                <textarea
                  name="description"
                  placeholder="Tell us about the program, what you learned, achievements..."
                  value={description}
                  onChange={onChange}
                  style={textareaStyle}
        ...
        {showSuccess && (
          ...
          >
            <CheckCircle size={20} />
            <span>Education added successfully!</span>
